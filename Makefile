...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Aug 18 18:03:31 2015
# Project:  reall.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		MySimpleTextItem.cpp moc_MainWindow.cpp \
		moc_MyGraphicsView.cpp
OBJECTS       = main.o \
		MainWindow.o \
		MyBrushItem.o \
		MyCentralEllipseItem.o \
		MyCentralGraphicsItem.o \
		MyCentralRectItem.o \
		MyCentralRectRadiousItem.o \
		MyDockTextItem.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/reall1.0.0/ && $(COPY_FILE) --parents MainWindow.h MyBrushItem.h MyCentralEllipseItem.h MyCentralGraphicsItem.h MyCentralRectItem.h MyCentralRectRadiousItem.h MyDockTextItem.h MyDropGraphicsScene.h MyEllipseItem.h MyGraphicsView.h MyOrganizationDockWidget.h MyPointF.h MyRectItem.h MyRectRadiousItem.h MySimpleTextItem.h .tmp/reall1.0.0/ && $(COPY_FILE) --parents main.cpp MainWindow.cpp MyBrushItem.cpp MyCentralEllipseItem.cpp MyCentralGraphicsItem.cpp MyCentralRectItem.cpp MyCentralRectRadiousItem.cpp MyDockTextItem.cpp MyDropGraphicsScene.cpp MyEllipseItem.cpp MyGraphicsView.cpp MyOrganizationDockWidget.cpp MyRectItem.cpp MyRectRadiousItem.cpp MySimpleTextItem.cpp .tmp/reall1.0.0/ && (cd `dirname .tmp/reall1.0.0` && $(TAR) reall1.0.0.tar reall1.0.0 && $(COMPRESS) reall1.0.0.tar) && $(MOVE) `dirname .tmp/reall1.0.0`/reall1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/reall1.0.0
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_MyGraphicsView.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_MyGraphicsView.cpp
...
moc_MyGraphicsView.cpp: MyDropGraphicsScene.h \
		MyCentralGraphicsItem.h \
		MyBrushItem.h \
		MySimpleTextItem.h \
		MyPointF.h \
		MyGraphicsView.h
	/usr/local/Cellar/qt/4.8.6/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ MyGraphicsView.h -o moc_MyGraphicsView.cpp
...
MyBrushItem.o: MyBrushItem.cpp MyBrushItem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyBrushItem.o MyBrushItem.cpp

MyCentralEllipseItem.o: MyCentralEllipseItem.cpp MyCentralEllipseItem.h \
		MyCentralGraphicsItem.h \
		MyBrushItem.h \
		MySimpleTextItem.h \
		MainWindow.h \
		...
		MyPointF.h \
		MyGraphicsView.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyCentralEllipseItem.o MyCentralEllipseItem.cpp
...
MyCentralRectRadiousItem.o: MyCentralRectRadiousItem.cpp MyCentralRectRadiousItem.h \
		MyCentralGraphicsItem.h \
		MyBrushItem.h \
		MySimpleTextItem.h \
		MyDropGraphicsScene.h \
		...
		MyDockTextItem.h \
		MyGraphicsView.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyCentralRectRadiousItem.o MyCentralRectRadiousItem.cpp

MyDockTextItem.o: MyDockTextItem.cpp MyDockTextItem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyDockTextItem.o MyDockTextItem.cpp
...
MyEllipseItem.o: MyEllipseItem.cpp MyEllipseItem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyEllipseItem.o MyEllipseItem.cpp
...
MyRectRadiousItem.o: MyRectRadiousItem.cpp MyRectRadiousItem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyRectRadiousItem.o MyRectRadiousItem.cpp

MySimpleTextItem.o: MySimpleTextItem.cpp MySimpleTextItem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MySimpleTextItem.o MySimpleTextItem.cpp

...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Aug 13 21:13:13 2015
# Project:  reall.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/reall1.0.0/ && $(COPY_FILE) --parents MainWindow.h MyCentralRectItem.h MyDropGraphicsScene.h MyGraphicsView.h MyOrganizationDockWidget.h MyRectItem.h .tmp/reall1.0.0/ && $(COPY_FILE) --parents main.cpp MainWindow.cpp MyCentralRectItem.cpp MyDropGraphicsScene.cpp MyGraphicsView.cpp MyOrganizationDockWidget.cpp MyRectItem.cpp .tmp/reall1.0.0/ && (cd `dirname .tmp/reall1.0.0` && $(TAR) reall1.0.0.tar reall1.0.0 && $(COMPRESS) reall1.0.0.tar) && $(MOVE) `dirname .tmp/reall1.0.0`/reall1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/reall1.0.0

...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Jul 15 14:46:43 2015
# Project:  reall.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/reall1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/reall1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/reall1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/reall1.0.0/ && (cd `dirname .tmp/reall1.0.0` && $(TAR) reall1.0.0.tar reall1.0.0 && $(COMPRESS) reall1.0.0.tar) && $(MOVE) `dirname .tmp/reall1.0.0`/reall1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/reall1.0.0

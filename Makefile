...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Aug 16 23:06:26 2015
# Project:  reall.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		MyRectItem.cpp \
		MyRectRadiousItem.cpp moc_MainWindow.cpp
OBJECTS       = main.o \
		MainWindow.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/reall1.0.0/ && $(COPY_FILE) --parents MainWindow.h MyCentralGraphicsItem.h MyCentralRectItem.h MyCentralRectRadiousItem.h MyDropGraphicsScene.h MyGraphicsView.h MyOrganizationDockWidget.h MyPointF.h MyRectItem.h MyRectRadiousItem.h .tmp/reall1.0.0/ && $(COPY_FILE) --parents main.cpp MainWindow.cpp MyCentralGraphicsItem.cpp MyCentralRectItem.cpp MyCentralRectRadiousItem.cpp MyDropGraphicsScene.cpp MyGraphicsView.cpp MyOrganizationDockWidget.cpp MyRectItem.cpp MyRectRadiousItem.cpp .tmp/reall1.0.0/ && (cd `dirname .tmp/reall1.0.0` && $(TAR) reall1.0.0.tar reall1.0.0 && $(COMPRESS) reall1.0.0.tar) && $(MOVE) `dirname .tmp/reall1.0.0`/reall1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/reall1.0.0

...
static const char qt_meta_stringdata_Dialog[] = {
    "Dialog\0\0index\0buttonsOrientationChanged(int)\0"
    "rotateWidgets()\0help()\0"
};
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->buttonsOrientationChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->rotateWidgets(); break;

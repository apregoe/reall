...
static const char qt_meta_stringdata_MyGraphicsView[] = {
    "MyGraphicsView\0selectionChanged()\0\0"
};
...
const QMetaObjectExtraData MyGraphicsView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyGraphicsView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_MyGraphicsView,
      qt_meta_data_MyGraphicsView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyGraphicsView::getStaticMetaObject() { return staticMetaObject; }
